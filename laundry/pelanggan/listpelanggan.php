    ...
    <div class="row no-gutters mt-5">
        <div class="sidebar bg-dark  mt-2 pr-4 pt-5">
            <ul class="nav flex-column ml-4 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="listpelanggan.php"><i class="fab fa-intercom mr-2"></i>Data Pelanggan</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item">
        ...
        <div class="utama">
        <h3 <i class="fab fa-intercom ml-5 mt-5">PELANGGAN</h3>
        <div class="tombol">
            <a href="formpelanggan.php"><button type="submit" class="btn btn-primary ml-5 mt-1">Tambah Pelanggan</button></a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="editpelanggan.php?id=<?php echo $pelanggan['id_pelanggan'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapuspelanggan.php?id=<?php echo $pelanggan['id_pelanggan'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                    </td>
                </tr>
