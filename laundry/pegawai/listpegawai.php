    ...
    <div class="row no-gutters mt-5">
        <div class="sidebar bg-dark  mt-2 pr-4 pt-5">
            <ul class="nav flex-column ml-4 mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="listpegawai.php"><i class="fas fa-user-tag mr-2"></i>Data Pegawai</a>
                    <hr class="bg-secondary">
                </li>
                <li class="nav-item">
        ...
        <div class="utama">
        <h3 <i class="fas fa-user-tag ml-5 mt-5 ">PEGAWAI</h3>
        <div class="tombol">
            <a href="formpegawai.php"><button type="submit" class="btn btn-primary ml-5 mt-1">Tambah Pegawai</button></a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="editpegawai.php?id=<?php echo $pegawai['id_pegawai'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapuspegawai.php?id=<?php echo $pegawai['id_pegawai'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                    </td>
                </tr>
